...
| `endpoint` | `string` | The Copilot API endpoint the usage record interacted with. |
...
| `github_request_id` | `string` | GitHub request identifier associated with the Copilot usage event. |